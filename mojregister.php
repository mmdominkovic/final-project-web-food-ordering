        ...
        <h1 class="mx-auto my-0 text-uppercase text-center"> <br> <br> Pizza Delicious</h1>
           ...
           <div class="col-sm-6">
               <div class="row pt-5">
				   ...
				   <br>
				   <br>
                       <h4>Get More tasty things with registration.</h4>
                      ...
                      <div class="login">
                       <ul class="nav nav-tabs">
						 ...
						 <form class="formValidate" id="formValidate" method="post" action="routers/register-router.php" novalidate="novalidate">
							   ...
							   <button name="register" a href="javascript:void(0);" onclick="document.getElementById('formValidate').submit();" type="submit" class="btn btn-primary btn-block">Submit</a></button>
